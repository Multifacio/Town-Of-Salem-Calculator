...
/**
 * The role group for which the Investigator sees that it is an Investigator, Consigliere, Mayor
 * @author Multifacio
 * @version 1.0
 * @since 2017-1-20
 */
public class InvestigatorClueInvestigatorConsigliereMayor extends FullInclude {
    
    public InvestigatorClueInvestigatorConsigliereMayor(Set<Role> amnesiacTurnedInto) {
