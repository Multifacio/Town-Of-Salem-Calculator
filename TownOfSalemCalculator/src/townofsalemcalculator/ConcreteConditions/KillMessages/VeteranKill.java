 ...
 * @since 2017-1-29
 */
public class VeteranKill implements ConcreteCondition {
    private final List<StartCategory> startCategories;
    
    public VeteranKill(List<StartCategory> startCategories) {
    ...
    public PrioritizedCondition getPrioritizedCondition(List<ConcreteCondition> previousConditions) {
        ...
        AbstractCondition hold = new MinimumRoleAmount(startCategories, new StandardInclude(new SingleRoleGroup(Veteran), amnesiacTurnedInto), 1); 
