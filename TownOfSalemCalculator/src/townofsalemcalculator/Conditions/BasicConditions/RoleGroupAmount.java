...
public class RoleGroupAmount implements Condition {
    private final List<RoleSelecter> roleSelecters; //The list of Role Selecters in which roleGroup must appear (at least/at most) amount of times
     ...
     */
    public RoleGroupAmount(List<RoleSelecter> roleSelecters, RoleGroup roleGroup, Comparison comparison, int amount) {
